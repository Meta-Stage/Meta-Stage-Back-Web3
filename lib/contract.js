...
// ------------- decode contract log Unregister ---------------

const decodeTrxUnregister = (web3, data, topics) => {
  const transaction = web3.eth.abi.decodeLog([{
    type: "uint256",
    name: "tokenId",
    indexed: true
...
export { decodeTrxTransfer4, decodeTrxUnlock, decodeTrxRegister, decodeTrxUnregister };