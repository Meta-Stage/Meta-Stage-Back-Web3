...
const writeDbIsRegistered = async (results) => {
    const query = 'UPDATE nftinfo SET isRegistered = 1 WHERE isRegistered = 0; ';
...
export { writeDbMintTicket, writeDbTicketInfo, writeDbPhotoCardInfo, writeDbPhotoOpened, writeDbIsRegistered, getNftInfo };